...
const startServer = async () => {
    ...
    //events
    accountsS2SOAuthClient.webEventConsumer.event("account.settings_updated", eventHandler);
    ...
    app.get('/getaccountsettings', async (req: express.Request, res: express.Response)=>{
        ...
        try {
          let responseData: object = await accountsS2SOAuthClient.endpoints.accounts.getAccountSettings({ path, query });
    ...
    app.patch('/updateaccountsettings', async (req: express.Request, res: express.Response)=>{
        ...
        try {
          let responseData: object = await accountsS2SOAuthClient.endpoints.accounts.updateAccountSettings({ body, path, query });
