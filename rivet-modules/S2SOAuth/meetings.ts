...
const startServer = async () => {
    ...
    app.get('/getmeeting', async (req: express.Request, res: express.Response)=>{
        ...
        try {
          let responseData: object = await meetingsS2SOAuthClient.endpoints.meetings.getMeeting({ path, query });
    ...
    app.delete('/deletemeeting', async (req: express.Request, res: express.Response)=>{
        ...
        try {
          let responseData: object = await meetingsS2SOAuthClient.endpoints.meetings.deleteMeeting({ path, query });
    ...
    app.patch('/updatemeeting', async (req: express.Request, res: express.Response)=>{
        ...
        try {
          let responseData: object = await meetingsS2SOAuthClient.endpoints.meetings.updateMeeting({ body, path, query });
