import { UsersOAuthClient, ConsoleLogger } from "@zoom/rivet/users";
...
const startServer = async () => {
    ...
    app.get('/getuser', async (req: express.Request, res: express.Response)=>{
        ...
        try {
          let responseData: any = await usersOAuthClient.endpoints.users.getUser({ path, query });
    ...
    app.delete('/deleteuser', async (req: express.Request, res: express.Response)=>{
        ...
        try {
          let responseData: any = await usersOAuthClient.endpoints.users.deleteUser({ path, query });
    ...
    app.patch('/updateuser', async (req: express.Request, res: express.Response)=>{
        ...
        try {
          let responseData: any = await usersOAuthClient.endpoints.users.updateUser({ body, path, query });
