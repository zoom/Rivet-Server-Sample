...
// node_modules/@zoom/rivet/users/users.mjs
var import_dayjs = __toESM(require_dayjs_min(), 1);
var import_form_data = __toESM(require_form_data(), 1);
var createRivetErrors = (errors) => ({
  createError: (errorCode) => class extends Error {
    errorCode = errors[errorCode];
    constructor(message, options) {
      const errorMessage = message ?? (options?.cause instanceof Error ? options.cause.message : errorCode);
      super(errorMessage, options);
      this.name = errorCode;
      Object.setPrototypeOf(this, new.target.prototype);
    }
  },
  isError: (obj, key) => key ? Object.keys(errors).some((code) => code === key) && typeof obj.errorCode === "string" && obj.errorCode === errors[key] : typeof obj.errorCode === "string"
});
var coreErrors = {
...
var { createError: createCoreError, isError: isCoreError } = createRivetErrors(coreErrors);
var ApiResponseError = createCoreError("ApiResponseError");
var AwsReceiverRequestError = createCoreError("AwsReceiverRequestError");
var ClientCredentialsRawResponseError = createCoreError("ClientCredentialsRawResponseError");
var S2SRawResponseError = createCoreError("S2SRawResponseError");
var CommonHttpRequestError = createCoreError("CommonHttpRequestError");
var ReceiverInconsistentStateError = createCoreError("ReceiverInconsistentStateError");
var ReceiverOAuthFlowError = createCoreError("ReceiverOAuthFlowError");
var HTTPReceiverConstructionError = createCoreError("HTTPReceiverConstructionError");
var HTTPReceiverPortNotNumberError = createCoreError("HTTPReceiverPortNotNumberError");
var HTTPReceiverRequestError = createCoreError("HTTPReceiverRequestError");
var OAuthInstallerNotInitializedError = createCoreError("OAuthInstallerNotInitializedError");
var OAuthTokenDoesNotExistError = createCoreError("OAuthTokenDoesNotExistError");
var OAuthTokenFetchFailedError = createCoreError("OAuthTokenFetchFailedError");
var OAuthTokenRawResponseError = createCoreError("OAuthTokenRawResponseError");
var OAuthTokenRefreshFailedError = createCoreError("OAuthTokenRefreshFailedError");
var OAuthStateVerificationFailedError = createCoreError("OAuthStateVerificationFailedError");
var ProductClientConstructionError = createCoreError("ProductClientConstructionError");
var LogLevel;
(function(LogLevel2) {
...
(function(StatusCode2) {
  ...
  StatusCode2[StatusCode2["TEMPORARY_REDIRECT"] = 302] = "TEMPORARY_REDIRECT";
...
var DEFAULT_LOGLEVEL = LogLevel.ERROR;
